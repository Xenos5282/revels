window.addEventListener('load', function(){
    ...
    function load_events(cat)
    {
      ...
      x.innerHTML = ""
      //console.log(cat)
      for(var i = 1;i<=events_json.data.length;i=i+1)
      {
        if(events_json.data[i-1].category == cat)
        {
          var k = createCard(events_json.data[i-1]);
          x.appendChild(k);
        }
      }
    }
    ...
    var fetch_cat = function()
    {
        fetch('https://api.mitrevels.in/categories',{
            ...
            {
              if(json.data[i].id != 139 && json.data[i].id != 142 && json.data[i].id != 143 && json.data[i].id != 146 && json.data[i].id != 147 && json.data[i].id != 150 && json.data[i].id != 162 && json.data[i].id != 172 && json.data[i].id != 175 && json.data[i].id != 185 && json.data[i].id != 140 && json.data[i].id != 141 && json.data[i].id != 144 && json.data[i].id != 151 && json.data[i].id != 167 && json.data[i].id != 139 && json.data[i].id != 176 && json.data[i].id != 145 && json.data[i].id != 183 && json.data[i].id != 168 && json.data[i].id != 184)
